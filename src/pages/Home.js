...
For those with more Chinese dance experience, we hold auditions for the FTD performing team at the beginning of every semester. </p>
                ...
                <div className="join">
                    ...
                    <div className="join__section">
                        ...
                        <div className="join__text">Practice times and frequency depend on the choreographer and dancers' schedules. They are typically 3-4 hours a week. We may also offer minipieces, which require less time committment, typically 1-2 hours a week.</div>
                    </div><br/>
                    <div className="join__section">
                        <div className="join__title">AUDITIONS</div>
                        <div className="join__subtitle">ATTIRE</div>
                        <div className="join__text">No baggy pants, jeans, or baggy shirts. 
Bring dance shoes (ballet shoes, jazz shoes, etc.) or your bare feet. </div>
